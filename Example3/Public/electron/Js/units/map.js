  ...
  return class Map
  {
    ...
    _createReceiverLabel( receiver )
    {
      // Create new <text> element and use the static band template.
        ...
        const labelText = document.createTextNode(receiver.description)
    ...
    addReceiver( receiver )
    {
      ...
      // Create an id for this receiverElement.
        ...
        //display hover contorller-receiver
        const receiverConfiguration = this.system.receivers[receiver.id]
      ...
      receiverElement.onmouseover =
        function()
        {
          $( receiverElement ).addClass( "svgIconHighlight" )
            ...
            $(receiverElement).w2tag("Zone: " + controllerConfiguration.address + " - " + receiverConfiguration.channel, { position: "top", left: 17, top: 7 })
        }
    ...
    showMap( mapId, configuration )
    {
      ...
      this.drawConnections()
        ...
        //$("#floorPlan").css("margin-left", "50px")
