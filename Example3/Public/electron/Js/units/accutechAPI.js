  ...
  return class AccutechAPI
  {
    ...
    saveAssetSet( assets, callback = null )
    {
      ...
      for ( const [ id, data ] of Object.entries( assets ) )
          request[id] = { name: "database.setAsset", parameters : [ id, data ] }
    ...
    {
        return this.webSocketAPI.makeRequest("database.setAsset", [id, data], callback)
    }
    ...
    constructor( webSocketAPI )
    {
      ...
      this.navigation = new WebSocketCRUDNAF( webSocketAPI, "navigation", "database" )
