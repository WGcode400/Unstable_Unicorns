...
)
{
  return class WebSocketCRUDNAF
  {
    ...
    create( data, callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".create", parameters )
          .done( callback )
    ...
    read( id, callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".read", parameters )
          .done( callback )
    ...
    update( id, data, callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".update", parameters )
          .done( callback )
    ...
    delete( id, callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".delete", parameters )
          .done( callback )
    ...
    readAll( callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".readAll", parameters )
          .done( callback )
    ...
    flush( callback )
    {
      ...
      const result =
        this._webSocketAPI
          .makeRequest( this._source + ".flush", parameters )
          .done( callback )
